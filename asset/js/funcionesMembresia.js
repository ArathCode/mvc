    ...
    .then(data => {
        ...
        data.lista.forEach(membresia => {
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-editar" data-id="${membresia.ID_Usuario}" data-bs-toggle="modal" data-bs-target="#modalEditar">Editar</button>
                    <button class="btn btn-danger btn-eliminar" data-id="${membresia.ID_Usuario}">Eliminar</button>
